...
#import shutil
#FileList=glob.glob("H:/NarrowbandData/Tunisia/2017/09/30/*NAA*A.mat")
#dest_dir="H:/NarrowbandData/Tunisia/2017/09/NAA"
#for filename in FileList:
#    print(filename)
#    shutil.copy(filename, dest_dir)
AveragingTime = 60
FileList=glob.glob("H:/NarrowbandData/Tunisia/2017/09/NAA/*NAA*A.mat")
...
plt.imshow(20*np.log10(AmpNS), interpolation='nearest', cmap='plasma',
           origin='lower', extent=[0, 24 , 0, Range],aspect='auto')
plt.colorbar()
fig.add_subplot(1, 2, 2)

plt.imshow(20*np.log10(AmpEW), interpolation='nearest', cmap='plasma',
           origin='lower', extent=[0, 24 , 0, Range],aspect='auto')
plt.colorbar()
plt.show()
